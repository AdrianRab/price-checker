...
class RoomDetailsParserTest {
    ...
    public void shouldParseResponse() throws JsonProcessingException {
        ...
        //when
        RoomDetails result = RoomDetailsParser.parseJson(response, "some details");
    ...
    public void shouldNotParseResponse_ExceptionExpected() {
        ...
        //when then
        assertThrows(IllegalStateException.class, () -> RoomDetailsParser.parseJson(response, "some details"));
    }
